...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    ...
    component: () => import('./create-_omQGvSx.mjs')
  },
  {
    name: "app",
    path: "/app",
    component: () => import('./app-m58F0Zma.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DiJHDEY2.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-NtFCZHCB.mjs')
  },
  {
    name: "sign-in",
    path: "/sign-in",
    component: () => import('./sign-in-GJVxh9wh.mjs')
  },
  {
    name: "sign-up",
    path: "/sign-up",
    component: () => import('./sign-up-B2XHZrJE.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C169DQLS.mjs')
  }
];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "min-height": "100vh", "display": "grid", "place-items": "center", "font-family": "Inter,Arial,sans-serif" } }, _attrs))}><div style="${ssrRenderStyle({ "text-align": "center" })}"><h1 style="${ssrRenderStyle({ "margin": "0 0 8px", "font-size": "24px" })}">Something went wrong</h1><p style="${ssrRenderStyle({ "margin": "0 0 16px", "color": "#64748b" })}">Please try again.</p><button style="${ssrRenderStyle({ "height": "40px", "padding": "0 16px", "border-radius": "8px", "border": "1px solid #d5d9e1", "background": "#fff", "cursor": "pointer" })}">Back to app</button></div></div>`);
    };
  }
});
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, entry_default as default, encodeRoutePath as e, hashMode as h, navigateTo as n, resolveRouteObject as r, useRouter as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
