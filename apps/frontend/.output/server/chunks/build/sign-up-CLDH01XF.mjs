globalThis.__timing__.logStart('Load chunks/build/sign-up-CLDH01XF');import { defineComponent, ref, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, withDirectives, isRef, vModelText, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderAttr } from 'vue/server-renderer';
import { u as useGoogleAuth, a as useAuthApi, _ as _sfc_main$1, r as resolvePostAuthRedirectPath } from './use-google-auth-BqGWFBY2.mjs';
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/sign-up-CLDH01XF');
//# sourceMappingURL=sign-up-CLDH01XF.mjs.map
