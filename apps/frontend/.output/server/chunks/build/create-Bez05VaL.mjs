globalThis.__timing__.logStart('Load chunks/build/create-Bez05VaL');import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useWorkspace, a as useChatApi } from './use-chat-api-UWi158vj.mjs';
import './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/create-Bez05VaL');
//# sourceMappingURL=create-Bez05VaL.mjs.map
