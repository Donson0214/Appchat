globalThis.__timing__.logStart('Load chunks/build/use-google-auth-DiomOngO');import { defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, shallowRef, h, resolveComponent, computed, unref, useSSRContext } from 'vue';
import { y as parseQuery, n as hasProtocol, k as joinURL, z as withTrailingSlash, A as withoutTrailingSlash } from '../_/nitro.mjs';
import { u as useNuxtApp, c as useRuntimeConfig, b as useRouter, e as encodeRoutePath, r as resolveRouteObject, n as navigateTo, h as hashMode, d as nuxtLinkDefaults } from './server.mjs';
...
export { _sfc_main as _, useAuthApi as a, getPostAuthRedirectPath as g, useGoogleAuth as u };;globalThis.__timing__.logEnd('Load chunks/build/use-google-auth-DiomOngO');
//# sourceMappingURL=use-google-auth-DiomOngO.mjs.map
